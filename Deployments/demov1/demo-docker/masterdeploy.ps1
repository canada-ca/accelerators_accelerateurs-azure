...
Get-AzureRmMarketplaceTerms -Publisher bitnami -Product nginxstack -Name "1-9" | Set-AzureRmMarketplaceTerms -Accept
.\scripts\deployrgv2.ps1 -configFilePath $configFilePath -templateLibraryName servers/20190307.1 -parametersFileName .\deploy-60-servers.parameters.json -resourceGroupName Demo-Shared-Sandbox-RG