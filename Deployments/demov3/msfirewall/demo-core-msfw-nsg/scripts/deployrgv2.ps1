...
Write-Host "Starting deployment...";
    ...
    if ($AsJob) {
        New-AzureRmResourceGroupDeployment -ResourceGroupName $resourceGroupName -Name $deploymentName -TemplateUri $url -TemplateParameterFile $parametersFileNameResolve -Verbose -AsJob
    } 
    else {
        New-AzureRmResourceGroupDeployment -ResourceGroupName $resourceGroupName -Name $deploymentName -TemplateUri $url -TemplateParameterFile $parametersFileNameResolve -Verbose
    }
