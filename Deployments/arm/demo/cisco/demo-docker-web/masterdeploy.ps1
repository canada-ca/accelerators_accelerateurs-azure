...
Param(
    ...
    [string]$containerName = "demo-docker-web",
...
$corePUBLICip = (Get-AzureRmResourceGroupDeployment -ResourceGroupName Demo-Infra-FWCore-RG -Name "CiscoASAV2NIC-deploy-demo-asav-core").Outputs.publicIP.value
